...
void keyb_event(u32 ch)
{
	...
	//write_str(buf_ch, attr_norm, CHAROUT + SCREEN_COL_SIZE*2*2);

	// scan codes
	switch(ch)
	{
		case 0x02: calc(1, 1); break;	// 1
		case 0x03: calc(2, 2); break;	// 2
		case 0x04: calc(3, 3); break;	// 3
		case 0x05: calc(4, 4); break;	// 4
		case 0x06: calc(5, 5); break;	// 5
		case 0x07: calc(6, 6); break;	// 6
		case 0x08: calc(7, 7); break;	// 7
		case 0x09: calc(8, 8); break;	// 8
		case 0x0a: calc(9, 9); break;	// 9
		case 0x0b: calc(10, 10); break;	// 0
