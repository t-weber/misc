...
private:
	...
	bool m_portal = false;
	t_mat_gl m_mat_portal = m::unit<t_mat_gl>();
...
public:
	std::size_t AddPlane(t_real_gl size,
	...
	void SetObjectPortal(std::size_t idx, bool portal);
	void SetObjectPortalMatrix(std::size_t idx, const t_mat_gl& mat);
